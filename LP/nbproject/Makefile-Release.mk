...
${OBJECTDIR}/materials_in_product.o: materials_in_product.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/materials_in_product.o materials_in_product.c
...
${OBJECTDIR}/products_in_order.o: products_in_order.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/products_in_order.o products_in_order.c
